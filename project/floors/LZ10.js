main.floors.LZ10=
{
    ...
    "firstArrive": [
        ...
        "\t[${flag:shengqishi_name},N510]\b[this,4,3]这条龙，看起来也不过如此嘛！",
        "\t[黛默琳,N481]\b[this,4,7]小子，你有多大的本事，竟敢如此夸口！",
        "\t[${flag:shengqishi_name},N510]\b[this,4,3]有多大的本事，你试试我的拳头不就知道了？",
        "\t[黛默琳,N481]\b[this,4,7]要知道，我还从未输过呢！",
        "\t[${flag:shengqishi_name},N510]\b[this,4,3]哦？是吗？那正好，我也从未输过。",
        ...
        "\t[${flag:shengqishi_name},N510]\b[this,4,3]一往无前！",
        {
            "type": "jump",
            "from": [
                4,
        ...
        "\t[${flag:shengqishi_name},N510]\b[this,4,6]哼！圣光守护！",
        {
            "type": "animate",
            "name": "emo",
            "loc": [
        ...
        "\t[${flag:shengqishi_name},N510]\b[this,4,3]再来！",
        {
            "type": "jump",
            "from": [
                4,
        ...
        "\t[${flag:shengqishi_name},N510]\b[this,4,3]不错嘛！",
        "\t[${flag:shengqishi_name},N510]\b[this,4,3]圣子殿下！",
        "\t[莫析辉,hero]\b[hero]知道！",
        "\t[${flag:shengqishi_name},N510]\b[this,4,3]再吃我一招！",
        {
            "type": "jump",
            "from": [
                4,
        ...
        },
        {
            ...
            "true": [
                ...
                "\t[${flag:shengqishi_name},N510]\b[this,4,6]嗯，那殿下，我们回去吧！",
                "\t[莫析辉,hero]\b[hero]我想，我们应该先去\r[red]\\c[30]精灵王国\\c[]\r[]、兽人族、矮人族看看老同学了……",
                "\t[${flag:shengqishi_name},N510]\b[this,4,6]啊？",
